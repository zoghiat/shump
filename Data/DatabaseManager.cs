...
public static class DatabaseManager
{
    ...
    public static void Init()
    {
       // اتصال به دیتابیس
        ...
        if (count == 0)
        {
            ...
            insert.CommandText =
            """
            INSERT INTO PlayerData(Id, TotalCoins, HighScore, EquippedShipSkin, EquippedBulletStyle, EquippedBackground, ExtraLifeBooster)
            VALUES(1, 0, 0, 'default_ship', 'default_bullet', 'default_space', 0)
            """;
            // پیاده کردن دستورات
    ...
    public static PlayerSave LoadPlayerSave()
    {
        ...
        using SqliteCommand cmd = connection.CreateCommand();
        cmd.CommandText = "SELECT TotalCoins, HighScore, EquippedShipSkin, EquippedBulletStyle, EquippedBackground, ExtraLifeBooster FROM PlayerData WHERE Id = 1";
