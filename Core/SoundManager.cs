...
public static class SoundManager
{
    ...
    private static WaveOutEvent? backgroundOutput; // خروجی پخش صدا
    private static AudioFileReader? backgroundReader; // خواننده فایل صوتی
    private static LoopStream? backgroundLoop; // استریم با قابلیت پخش حلقه‌ای

    
    // لیست افکت‌های صوتی در حال پخش
    private static readonly List<WaveOutEvent> activeSfx = new List<WaveOutEvent>(); 

    // ساخت مسیر کامل فایل صوتی در پوشه Assets/Sounds
